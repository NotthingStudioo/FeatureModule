...
namespace DA_Assets.FCU.Drawers.CanvasDrawers
{
    ...
    public class ButtonDrawer : MonoBehaviourBinder<FigmaConverterUnity>
    {
        ...
        public void Init() { buttons = new List<SyncData>(); }
        ...
        public void Draw(FObject fobject)
        {
            ...
            switch (monoBeh.Settings.ComponentSettings.ButtonComponent)
            {
                ...
                case ButtonComponent.FEATURE_TEMPLATE_BUTTON:
                    fobject.Data.GameObject.TryAddComponent(out FeatureButtonView _);
            ...
            foreach (SyncData syncData in buttons)
            {
                switch (syncData.ButtonComponent)
                {
                    ...
                    case ButtonComponent.DAButton:
                        ...
                        break;
                    case ButtonComponent.FEATURE_TEMPLATE_BUTTON:
                        this.UnityButtonDrawer.SetUpFeatureTemplateButton(syncData);
        ...
        [SerializeProperty(nameof(dabDrawer))] public DAButtonDrawer DAButtonDrawer => dabDrawer.SetMonoBehaviour(monoBeh);
        ...
        [SerializeProperty(nameof(ubDrawer))] public UnityButtonDrawer UnityButtonDrawer => ubDrawer.SetMonoBehaviour(monoBeh);
    }
}