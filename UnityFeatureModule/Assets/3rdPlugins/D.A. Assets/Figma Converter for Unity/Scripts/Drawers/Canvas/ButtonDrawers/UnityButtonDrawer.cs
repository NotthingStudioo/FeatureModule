...
namespace DA_Assets.FCU.Drawers.CanvasDrawers
{
    ...
    public class UnityButtonDrawer : MonoBehaviourBinder<FigmaConverterUnity>
    {
        public void SetUpFeatureTemplateButton(SyncData btnSyncData)
        {
            ...
            {
                SetCustomTargetGraphics(syncHelpers, component.btnOnClick);
            }
            else
            {
                SetDefaultTargetGraphic(syncHelpers, component.btnOnClick);
            }
        }
